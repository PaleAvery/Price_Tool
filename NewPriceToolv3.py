...
# prints out the multiple different options and their catagory such as weight grams , weight kilos , cost $ , unit price $, User budget
...
# filters the remaining stuff in regards of budget in two step
...
if applec > budget:
    ...
    applewg = 'xxx'
    appleup = 'xxx'
if chocolatec > budget:
    chocolatec = 'xxx'
    chocolatewk = 'xxx'
    chocolateng = 'xxx'
    chocolateup = 'xxx'
if chocolatec and applec and chipsc == 'xxx': print("you are poor come back later")


#step two if possible find the best possible options in regards to price per kilo
# chipsc applec chocolatec
c = [['Chips',chipswg,chipswk ,chipsc ,chipsup,budget], ['Apple',applewg,applewk,applec,appleup ], ['Chocolate',chocolatewg,chocolatewk,chocolatec,chocolateup]] # data
d = ['Name', 'Weight Grams','Weight Kilos', 'Cost[$]', 'Unit Price per kilo','User Budget'] # headers
print("this is the available products")
print(tabulate(c, headers=d))
