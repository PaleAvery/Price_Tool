...
a = [[chipswg, chipswk, chipsc,chipsup ], [f'{applewg:.2f}',applewk,applec,appleup ], [chocolatewg,chocolatewk,chocolatec,chocolateup ]] # data
b = [ 'Weight Grams','Weight Kilos', 'Cost[$]', 'Unit Price per kilo'] # headers
print("this is the available products")
formatted_list = [f"{x:.2f}" for x in a]
print(formatted_list)
print(tabulate(formatted_list, headers=b))